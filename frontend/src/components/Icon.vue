...
const ICONS = {
  ...
  network: '<circle cx="12" cy="5" r="2.5"/><circle cx="5" cy="19" r="2.5"/><circle cx="19" cy="19" r="2.5"/><path d="M12 7.5v4m0 0-5.4 4.8M12 11.5l5.4 4.8"/>',
  ...
  'shield-alert': '<path d="M12 22s8-3.6 8-10V5l-8-3-8 3v7c0 6.4 8 10 8 10z"/><path d="M12 8v4"/><path d="M12 16h.01"/>',
  ...
  'user-cog': '<circle cx="10" cy="7" r="4"/><path d="M10.3 15H7a4 4 0 0 0-4 4v2"/><circle cx="17.5" cy="17.5" r="2.5"/><path d="M17.5 13v1m0 7v1m4.5-4.5h-1m-7 0h-1m7.3-3.2-.7.7m-4.9 4.9-.7.7m6.3 0-.7-.7m-4.9-4.9-.7-.7"/>',
